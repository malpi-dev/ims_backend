...
let Person = class Person extends base_schema_1.BaseSchema {
    userId;
    name;
    surnames;
    birthday;
...
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.SchemaTypes.ObjectId, ref: 'User', required: true, unique: true }),
...
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Person.prototype, "surnames", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
...
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Person.prototype, "profileImage", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
