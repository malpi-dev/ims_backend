...
__decorate([
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateAttributeDto.prototype, "code", void 0);
__decorate([
    (0, class_validator_1.IsEnum)(['string', 'number', 'boolean', 'date', 'enum', 'json', 'ip', 'mac']),
    __metadata("design:type", String)
], CreateAttributeDto.prototype, "valueType", void 0);
