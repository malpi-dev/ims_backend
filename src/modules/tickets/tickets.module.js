...
const ticket_problem_types_controller_1 = require("./ticket-problem-types.controller");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                ...
                { name: ticket_problem_type_schema_1.TicketProblemType.name, schema: ticket_problem_type_schema_1.TicketProblemTypeSchema },
                { name: product_schema_1.Product.name, schema: product_schema_1.ProductSchema },
            ]),
        ],
        controllers: [tickets_controller_1.TicketsController, ticket_problem_types_controller_1.TicketProblemTypesController],
