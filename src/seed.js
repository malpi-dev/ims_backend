...
const person_schema_1 = require("./modules/auth/schemas/person.schema");
const client_schema_1 = require("./modules/clients/schemas/client.schema");
const area_schema_1 = require("./modules/clients/schemas/area.schema");
const brand_schema_1 = require("./modules/inventory/schemas/brand.schema");
const model_schema_1 = require("./modules/inventory/schemas/model.schema");
const product_type_schema_1 = require("./modules/inventory/schemas/product-type.schema");
const attribute_schema_1 = require("./modules/inventory/schemas/attribute.schema");
const attribute_option_schema_1 = require("./modules/inventory/schemas/attribute-option.schema");
const product_type_attribute_schema_1 = require("./modules/inventory/schemas/product-type-attribute.schema");
const product_schema_1 = require("./modules/inventory/schemas/product.schema");
const product_attribute_value_schema_1 = require("./modules/inventory/schemas/product-attribute-value.schema");
const part_schema_1 = require("./modules/inventory/schemas/part.schema");
const product_part_schema_1 = require("./modules/inventory/schemas/product-part.schema");
const ticket_problem_type_schema_1 = require("./modules/tickets/schemas/ticket-problem-type.schema");
const ticket_schema_1 = require("./modules/tickets/schemas/ticket.schema");
async function bootstrap() {
    const app = await core_1.NestFactory.createApplicationContext(app_module_1.AppModule);
    const userModel = app.get((0, mongoose_1.getModelToken)(user_schema_1.User.name));
    const personModel = app.get((0, mongoose_1.getModelToken)(person_schema_1.Person.name));
    const clientModel = app.get((0, mongoose_1.getModelToken)(client_schema_1.Client.name));
    const areaModel = app.get((0, mongoose_1.getModelToken)(area_schema_1.Area.name));
    const brandModel = app.get((0, mongoose_1.getModelToken)(brand_schema_1.Brand.name));
    const modelModel = app.get((0, mongoose_1.getModelToken)(model_schema_1.Model.name));
    const productTypeModel = app.get((0, mongoose_1.getModelToken)(product_type_schema_1.ProductType.name));
    const attributeModel = app.get((0, mongoose_1.getModelToken)(attribute_schema_1.Attribute.name));
    const optionModel = app.get((0, mongoose_1.getModelToken)(attribute_option_schema_1.AttributeOption.name));
    const productTypeAttributeModel = app.get((0, mongoose_1.getModelToken)(product_type_attribute_schema_1.ProductTypeAttribute.name));
    const productModel = app.get((0, mongoose_1.getModelToken)(product_schema_1.Product.name));
    const productAttributeValueModel = app.get((0, mongoose_1.getModelToken)(product_attribute_value_schema_1.ProductAttributeValue.name));
    const partModel = app.get((0, mongoose_1.getModelToken)(part_schema_1.Part.name));
    const productPartModel = app.get((0, mongoose_1.getModelToken)(product_part_schema_1.ProductPart.name));
    const problemTypeModel = app.get((0, mongoose_1.getModelToken)(ticket_problem_type_schema_1.TicketProblemType.name));
    ...
    await personModel.insertMany(users.map((user) => ({ userId: user._id })));
